...
|---|---:|---|---|
| Educational framing | 2.5/4 | audience, misconceptions and three-experience progression frozen | completed documentation audit and expert review |
...
| Venue fit and requirements | 3.25/4 | official EAAI-27 call plus machine-checkable double-blind plan | reviewed anonymous artifact and author-kit monitoring |
| Novelty/documentation gap | 1.5/4 | predefined audit protocol passed CI | retained sample, independent double-coding and adjudication |
...
**Weighted coordination estimate: 55%**

The increase reflects validated double-blind and documentation-audit contracts plus correction of stale venue planning. It gives no credit for learner benefit, independent correctness, measured native/container reproducibility, combined-branch execution, completed retrospective analysis, an anonymous artifact or a completed audit.

## Two-week milestone status

- **Week 1 foundation: 94%** — contracts, fixtures, vertical slices and validators exist; canonical integration remains unresolved.
- **Week 2 vertical slices: 48%** — the accepted learner route exists, but measured Lab 0 tiers and one integrated execution do not.
- **Evidence package: 42%** — venue, benchmark, retrospective, double-blind and audit protocols exist; completed evaluation, broader extraction and independent correctness are absent.
...
## Submission-critical open gates

- no reviewed anonymous double-blind artifact;
- no completed documentation-gap audit;
- no integrated keyboard/screen-reader exercise;
- no retained human-labor and cost synthesis.
