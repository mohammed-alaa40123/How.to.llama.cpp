...
SOURCE_URL_BASE="https://github.com/ggml-org/llama.cpp/blob/$REV"
...
python3 "$ROOT/scripts/index_upstream.py" "$WORKTREE" \
  --out "$ROOT/data/generated/source-index.json" \
  --markdown "$ROOT/docs/reference/generated-source-inventory.md" \
  --source-url-base "$SOURCE_URL_BASE"
